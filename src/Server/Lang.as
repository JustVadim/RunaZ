package Server 
{
	...
	public class Lang 
	{
		...
		public static function init():void
		{
			...
			Lang.lang_table[158] = ["Купить VIP", "", ""];
			...
			Lang.lang_table[161] = ["Вы активировали VIP аккаунт на 14 дней", "",""];
			...
			Lang.lang_table[172] = [	["", "", ""], 
										["<font color=\"#00FF00\">Малая баночка здоровья</font>\n\nВосстанавливает 20 единиц или 20% здоровья в бою.\n\n<font color=\"#11B1FF\">Использовать можно только 1 раз.</font>", "", ""], 
										["<font color=\"#00FF00\">Средняя баночка здоровья</font>\n\nВосстанавливает 35 единиц или 35% здоровья в бою.\n\n<font color=\"#11B1FF\">Использовать можно только 1 раз.</font>", "", ""], 
										["<font color=\"#00FF00\">Большая баночка здоровья</font>\n\nВосстанавливает 45 единиц или 45% здоровья в бою.\n\n<font color=\"#11B1FF\">Использовать можно только 1 раз.</font>", "", ""], 
										["<font color=\"#00FF00\">Малая баночка манны</font>\n\nВосстанавливает 20 единиц или 20% манны в бою.\n\n<font color=\"#11B1FF\">Использовать можно только 1 раз.</font>", "", ""], 
										["<font color=\"#00FF00\">Средняя баночка манны</font>\n\nВосстанавливает 35 единиц или 35% манны в бою.\n\n<font color=\"#11B1FF\">Использовать можно только 1 раз.</font>", "", ""],
										["<font color=\"#00FF00\">Большая баночка манны</font>\n\nВосстанавливает 50 единиц или 50% манны в бою.\n\n<font color=\"#11B1FF\">Использовать можно только 1 раз.</font>", "", ""], 
										["<font color=\"#00FF00\">Свиток защиты</font>\n\nПоднимает защиту юнита в бою на 45% на один ход.\n\n<font color=\"#11B1FF\">Использовать можно только 1 раз.</font>", "", ""], 
										["<font color=\"#00FF00\">Свиток атаки</font>\n\nПоднимает атаку юнита в бою на 45% на один ход.\n\n<font color=\"#11B1FF\">Использовать можно только 1 раз.</font>", "", ""],
										["<font color=\"#00FF00\">Свиток максимального урона</font>\n\nНа один ход урон юнита будет максимальный.\n\n<font color=\"#11B1FF\">Использовать можно только 1 раз.</font>", "", ""],
										["<font color=\"#00FF00\">Свиток скорости</font>\n\nПоднимает скорость юнита на 2 клетки на 1 ход.\n\n<font color=\"#11B1FF\">Использовать можно только 1 раз.</font>", "", ""]];
		...
		static public function getUltimateText(unitType:int, level:int):String {
			var str:String = "<font color=\"#00FF00\">" + Lang.getTitle(13, unitType) + "</font>" + "\n" + Lang.getTitle(14, unitType);
			var bc:Object = UserStaticData.buffs_chances;
			if(level != 0) {
				str +=  "\n<font color=\"#FF8040\">" + Lang.getTitle(196) + ": " + bc[5 + unitType][level] + "</font>";
				if (level < 24)
					str += "\n" +  "<font color=\"#11B1FF\">" + Lang.getTitle(11) + ": " + bc[5 + unitType][level+1] + "</font>";
				else {
