package Server 
{
	...
	public class Lang 
	{
		...
		public static function init():void
		{
			...
			Lang.lang_table[172] = [	["", "", ""], 
										["Малая баночка здоровья\n\nВосстанавливает 15 единиц здоровья в бою. Использовать можно только 1 раз.", "", ""], 
										["Средняя баночка здоровья\n\nВосстанавливает 30 единиц здоровья в бою. Использовать можно только 1 раз.", "", ""], 
										["Большая баночка здоровья\n\nВосстанавливает 45 единиц здоровья в бою. Использовать можно только 1 раз.", "", ""], 
										["Малая баночка манны\n\nВосстанавливает 15 единиц манны в бою. Использовать можно только 1 раз.", "", ""], 
										["Средняя баночка манны\n\nВосстанавливает 30 единиц манны в бою. Использовать можно только 1 раз.", "", ""],
										["Большая баночка манны\n\nВосстанавливает 45 единиц манны в бою. Использовать можно только 1 раз.", "", ""], 
