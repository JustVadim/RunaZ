package Server 
{
	...
	public class Lang 
	{
		...
		public static function init():void
		{
			...
			Lang.lang_table[97] = ["Использовать 4 раза магию.\n\nДля этого вам надо зайти в карту миссий или в арену и начать бой. В бою любым юнитом надо использовать его магию, которая находится в правом нижнем углу. Проделав это 4 раза вы получите награду.", "", ""];
			Lang.lang_table[98] = ["Использовать 3 раза баночку здоровья.\n\nДля этого вам надо купить или положить из сундука баночку востановления здоровья, зайти в бой, и использовать по необходимости 3 раза.", "", ""];
