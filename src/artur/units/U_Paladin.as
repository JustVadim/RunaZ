package artur.units 
{
	...
	public class U_Paladin extends PallDoll
	{
		...
		public function U_Paladin() 
		{
			...
			heads = PrepareGr.creatBms(new ItemHeadPall(),false,U_Lyk.f);
			bodys = PrepareGr.creatBms(new ItemBodyPall(),false,U_Lyk.f);
			sikirs = PrepareGr.creatBms(new ItemGun1Pall(),false,U_Lyk.f);
			appArmsR = PrepareGr.creatBms(new ItemUpArmPall(),false,U_Lyk.f);
			hends1R  = PrepareGr.creatBms(new ItemHand1RPall(),false,U_Lyk.f);
			hends2R  = PrepareGr.creatBms(new ItemHand2RPall(),false,U_Lyk.f);
			hends1L  = PrepareGr.creatBms(new ItemHand1LPall(),false,U_Lyk.f);
			hends2L  = PrepareGr.creatBms(new ItemHand2LPall(),false,U_Lyk.f);
			legs1R =  PrepareGr.creatBms(new ItemLeg1RPall(),false,U_Lyk.f);
			legs2R =  PrepareGr.creatBms(new ItemLeg2RPall(),false,U_Lyk.f);
			legs3R =  PrepareGr.creatBms(new ItemLeg3RPall(),false,U_Lyk.f);
			legs1L =  PrepareGr.creatBms(new ItemLeg1LPall(),false,U_Lyk.f);
			legs2L =  PrepareGr.creatBms(new ItemLeg2LPall(),false,U_Lyk.f);
			legs3L =  PrepareGr.creatBms(new ItemLeg3LPall(),false,U_Lyk.f);
			sikirs2 =  PrepareGr.creatBms(new ItemShildPall(),false,U_Lyk.f);
