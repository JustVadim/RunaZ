	...
	public class U_Warwar extends BarbDoll
	{
		...
		public function U_Warwar() 
		{
		   this.mouseEnabled = false;
			...
			heads = PrepareGr.creatBms(new itemHead(),false,U_Lyk.f);
			bodys = PrepareGr.creatBms(new itemBody(),false,U_Lyk.f);
			sikirs = PrepareGr.creatBms(new itemSikir(),false,U_Lyk.f);
			appArmsR = PrepareGr.creatBms(new itemAppArm(),false,U_Lyk.f);
			hends1R  = PrepareGr.creatBms(new itemHend1R(),false,U_Lyk.f);
			hends2R  = PrepareGr.creatBms(new itemHend2R(),false,U_Lyk.f);
			hends3R  = PrepareGr.creatBms(new itemHend3R(),false,U_Lyk.f);
			appArmsL = PrepareGr.creatBms(new itemAppArm2(),false,U_Lyk.f);
			hends1L  = PrepareGr.creatBms(new itemHend1L(),false,U_Lyk.f);
			hends2L  = PrepareGr.creatBms(new itemHend2L(),false,U_Lyk.f);
			hends3L  = PrepareGr.creatBms(new itemHend3L(),false,U_Lyk.f);
			legs1R =  PrepareGr.creatBms(new itemLeg1R(),false,U_Lyk.f);
			legs2R =  PrepareGr.creatBms(new itemLeg2R(),false,U_Lyk.f);
			legs3R =  PrepareGr.creatBms(new itemLeg3R(),false,U_Lyk.f);
			legs1L =  PrepareGr.creatBms(new itemLeg1L(),false,U_Lyk.f);
			legs2L =  PrepareGr.creatBms(new itemLeg2L(),false,U_Lyk.f);
			legs3L =  PrepareGr.creatBms(new itemLeg3L(),false,U_Lyk.f);
