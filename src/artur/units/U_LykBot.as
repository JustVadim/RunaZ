package artur.units 
{
	...
	public class U_LykBot extends  LykDoll
	{
		...
		public function U_LykBot() 
		{
			...
			heads 	= RasterClip.getAnimationBitmaps(new ItemHeadBot3());// PrepareGr.creatBms();
			bodys 	= RasterClip.getAnimationBitmaps(new ItemBodyBot3());//PrepareGr.creatBms();
			bows  	= RasterClip.getAnimationBitmaps(new ItemGun1Bot3());//PrepareGr.creatBms();
		   appArmsR = RasterClip.getAnimationBitmaps(new ItemUpArmBot3());//PrepareGr.creatBms();
			hends1L = RasterClip.getAnimationBitmaps(new ItemHand1LBot3());//PrepareGr.creatBms();
			hends1R = RasterClip.getAnimationBitmaps(new ItemHand1RBot3());//PrepareGr.creatBms();
			hends2R = RasterClip.getAnimationBitmaps(new ItemHand2RBot3());//PrepareGr.creatBms();
			hends2L = RasterClip.getAnimationBitmaps(new ItemHand2LBot3());//PrepareGr.creatBms();
			legs1R 	= RasterClip.getAnimationBitmaps(new ItemLeg1RBot3());//PrepareGr.creatBms();
			legs2R 	= RasterClip.getAnimationBitmaps(new ItemLeg2RBot3());//PrepareGr.creatBms();
			legs3R 	= RasterClip.getAnimationBitmaps(new ItemLeg3RBot3());//PrepareGr.creatBms();
			legs1L 	= RasterClip.getAnimationBitmaps(new ItemLeg1LBot3());//PrepareGr.creatBms();
			legs2L 	= RasterClip.getAnimationBitmaps(new ItemLeg2LBot3());//PrepareGr.creatBms();
			legs3L 	= RasterClip.getAnimationBitmaps(new ItemLeg3LBot3());// PrepareGr.creatBms();
			arrows 	= RasterClip.getAnimationBitmaps(new ItemArrows());//PrepareGr.creatBms();
