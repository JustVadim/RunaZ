package artur.display.battle.eff 
{
	...
	{
		private var movs:Array = [new RasterMovie(new mcDamage1(), true), new RasterMovie(new effHill(), true), new RasterMovie(new effBAttleCry(), true), new RasterMovie(new mcEffArrow(), true)];
